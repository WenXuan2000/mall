...
const (
	...
	Order_CreateWODTM_FullMethodName  = "/order.Order/CreateWODTM"
...
func (c *orderClient) CreateWODTM(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	out := new(CreateResponse)
	err := c.cc.Invoke(ctx, Order_CreateWODTM_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	...
	CreateWODTM(context.Context, *CreateRequest) (*CreateResponse, error)
...
func (UnimplementedOrderServer) CreateWODTM(context.Context, *CreateRequest) (*CreateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateWODTM not implemented")
}
...
func _Order_CreateWODTM_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).CreateWODTM(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Order_CreateWODTM_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).CreateWODTM(ctx, req.(*CreateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Order_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateWODTM",
			Handler:    _Order_CreateWODTM_Handler,
		},
		{
